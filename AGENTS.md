...
When asked to make any kind of change to the codebase (feature, bugfix, refactor, etc), you should do the "Dev workflow" as documented below
...
6. Open a pull request with all the changes made. The PR title and description should be extremely succinct and cover: 1) why these changes are made, 2) the most significant changes.
